...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": ("authentication.auth.ApiTokenAuthentication",),
    ...
    "DEFAULT_THROTTLE_RATES": {"anon": "2/second", "user": "1000/minute"},
...
LOGGING = {
    ...
    "loggers": {
        ...
        "project": {"handlers": ["logfile", "server_console"], "level": "INFO", "propagate": False},
